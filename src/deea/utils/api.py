...
class AppFollowAPI:
    ...
    def collection_reviews(self, collection_name, **optionals):
        return self._api_call(
            path=f'/{collection_name}/reviews',
            params=optionals
        )
...
class Ingestor():
    ...
    def __init__(self, cid, sign):
        self.api = AppFollowAPI(cid, sign)

    def fetch(self, ext_id, **params):
        return self.api.reviews(ext_id, **params)

    def fetch_ratings(self, ext_id, **params):
        return self.api.ratings(ext_id, **params)
